/* v1.6 - FileUtilities | Loadable From Anywhere | Verified 1.12.2+ (1.12.2, 1.16.5) | Written by Rimscar */
...
var FUtil = (function () {
    return {
        ...
        WriteFile: function WriteFile(filepath, data) { return FUtil.P.WriteFile(filepath, data); },
        ...
        WriteLocalFile: function WriteLocalFile(filename, data) { return FUtil.P.WriteLocalFile(filename, data); },
        ...
        TerminateJVM: function TerminateJVM() { return FUtil.P.TerminateJVM(); },
