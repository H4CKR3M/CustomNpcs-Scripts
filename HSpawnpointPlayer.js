/* v3.0 - HSpawnpointPlayer | Playerscript | Verified 1.12.2+ (1.12.2, 1.16.5) | Written by Rimscar 
 * Requires: HyperSpawnpoint12
 */

var HSpawnpointPlayer = (function () { var _HSpawnpointPlayer = {};
    ...
    _HSpawnpointPlayer.AutoHookID = "HSpawnpointPlayer";
    _HSpawnpointPlayer.INTERNAL_Login = function (e) { P.Login(e); };
    _HSpawnpointPlayer.INTERNAL_Logout = function (e) { P.Logout(e); };
    return _HSpawnpointPlayer;
}());

HSpawnpointPlayer.COPY_login = (typeof login === 'function' && !login.hasOwnProperty(HSpawnpointPlayer.AutoHookID) && (Date.now() - (login.CreatedAt || Date.now())) < 200) ? login : function () { };
var login = function (e) {
    HSpawnpointPlayer.COPY_login(e);
    HSpawnpointPlayer.INTERNAL_Login(e);
}; login[HSpawnpointPlayer.AutoHookID] = true; login.CreatedAt = Date.now();

HSpawnpointPlayer.COPY_logout = (typeof logout === 'function' && !logout.hasOwnProperty(HSpawnpointPlayer.AutoHookID) && (Date.now() - (logout.CreatedAt || Date.now())) < 200) ? logout : function () { };
var logout = function (e) {
    HSpawnpointPlayer.COPY_logout(e);
    HSpawnpointPlayer.INTERNAL_Logout(e);
}; logout[HSpawnpointPlayer.AutoHookID] = true; logout.CreatedAt = Date.now();